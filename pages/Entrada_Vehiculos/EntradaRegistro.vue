<template>
  <section class="bg-slate-400">
    <div class="container p-4">
      ...
      >
      <MazBtn :key="lugDisp" class="mt-8" color="secondary"
        >Lugar a asignar: {{ lugDisp }}</MazBtn
      >
      ...
      <MazBtn rounded class="mt-6 w-52 mr-32" color="info" @click="Registro"
        >Registrar</MazBtn
      >

      <MazBtn rounded class="mt-6 mr-3" color="warning" @click="ServiciAdd"
        >Servicio adicional</MazBtn
      >
      <MazBtn rounded class="mt-6" color="warning" @click="MostrarTicket"
