<template>
    <section class="bg-slate-400">
        <div class="container p-4">
            <h1 style="color: black; font-family: Verdana; font-size: 36px;"><b>Promociones - Modificación</b></h1>            
            <MazInput class="mt-8" v-model="buscarPromocion" label="ID Promoción"/>
            <MazBtn class="mt-2 mb-5" color="black">Buscar promocion</MazBtn>
            <div class = "w-3/4 border bg-gradienttwo p-8 rounded-lg shadow-md">
                <h2 style="color: white; font-family: Verdana; font-size: 36px;" class="mt-8">Datos de la promoción:</h2>
